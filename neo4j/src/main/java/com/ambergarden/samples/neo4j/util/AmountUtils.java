 ...
 * 
 * @author Anhe
 * @create 2016年11月7日下午2:48:47
 * @update 2016年11月7日下午2:48:47
 * @version V1.0
 */
public class AmountUtils {
	 ...
	 * @return
	 */
	public static BigDecimal changeY2FB(BigDecimal amount) {
		return new BigDecimal(changeY2F(amount));
	}
	...
	public static void main(String[] args) {
		...
		// System.out.println(Long.parseLong(MoneyUtils.changeY2F("1000000000000000")));
